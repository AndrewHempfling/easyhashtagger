    ...
    _createClass(Chips, [{
      ...
      value: function _handleInputKeydown(e) {
        ...
        if (e.keyCode === 13) {
          ...
          e.preventDefault();
		  var hashTagMention = $("#" + e.target.id).closest("div").prop("className");
		  var hm = '';
		  if (hashTagMention === "mention chips chips-initial input-field focus") {
		  	hm = '@';
		  } else if (hashTagMention === "hashtag chips chips-initial input-field focus") {
		  	hm = '#';
		  } else {
			hm = '';
		  }
...
//alert()
//var hashTagMention = $("#" + e.target.id).closest("div").prop("className"); alert(hashTagMention === "mention chips chips-initial input-field focus"),
//$("#" + e.target.id).closest("div").prop("className") == "mention chips chips-initial input-field focus")
//hashtag chips chips-initial input-field focus
      /**
       * Render Chip
       * @param {chip} chip
       * @return {Element}
